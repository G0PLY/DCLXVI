		...
		if (!v16->_iPostDraw && (unsigned char)v49 <= MAXITEMS) {
			...
			if (v17) {
				...
				if (v18 >= 1 && *(_DWORD *)v17 <= 0x32u && v18 <= *(_DWORD *)v17) {
					...
					if (v49 - 1 == pcursitem)
						CelDrawHdrClrHL(ICOL_WHITE, v19, a5, v17, v16->_iAnimFrame, v16->_iAnimWidth, 0, 8);
					Cel2DecodeHdrLight(v19, a5, (char *)v16->_iAnimData, v16->_iAnimFrame, v16->_iAnimWidth, 0, 8);

					if (v49 - 1 != pcursitem && VK_MENU)
						CelDrawHdrClrHL(ICOL_BLUE, v19, a5, v17, v16->_iAnimFrame, v16->_iAnimWidth, 0, 8);
					Cel2DecodeHdrLight(v19, a5, (char *)v16->_iAnimData, v16->_iAnimFrame, v16->_iAnimWidth, 0, 8);
					if (v49 - 1 != pcursitem && !VK_MENU)
						CelDrawHdrClrHL(ICOL_RED, v19, a5, v17, v16->_iAnimFrame, v16->_iAnimWidth, 0, 8);
					Cel2DecodeHdrLight(v19, a5, (char *)v16->_iAnimData, v16->_iAnimFrame, v16->_iAnimWidth, 0, 8);
				}
			}
		}
			...
			if ((unsigned char)v49 <= MAXITEMS) {
				...
				if (v37) {
					...
					if (v38 >= 1 && *(_DWORD *)v37 <= 0x32u && v38 <= *(_DWORD *)v37) {
						...
						if (v49 - 1 == pcursitem)
							CelDrawHdrClrHL(ICOL_WHITE, v39, a5, v37, v36->_iAnimFrame, v36->_iAnimWidth, 0, 8);
						Cel2DecodeHdrLight(
							v39,
							a5,
							(char *)v36->_iAnimData,
						...
						Cel2DecodeHdrLight(
							...
							8);
						if (v49 - 1 != pcursitem && !VK_MENU)
							CelDrawHdrClrHL(ICOL_RED, v39, a5, v37, v36->_iAnimFrame, v36->_iAnimWidth, 0, 8);
						Cel2DecodeHdrLight(
							v39,
							a5,
							(char *)v36->_iAnimData,
		...
		if (!v19->_iPostDraw && (unsigned char)v52 <= MAXITEMS) {
			...
			if (v20) {
				...
				if (v21 >= 1 && *(_DWORD *)v20 <= 0x32u && v21 <= *(_DWORD *)v20) {
					...
					if (v52 - 1 == pcursitem)
						CelDrawHdrClrHL(ICOL_WHITE, v22, sy, v20, v19->_iAnimFrame, v19->_iAnimWidth, a5, 8);
					Cel2DecodeHdrLight(v22, sy, (char *)v19->_iAnimData, v19->_iAnimFrame, v19->_iAnimWidth, a5, 8);

					if (v52 - 1 != pcursitem && VK_MENU)
						CelDrawHdrClrHL(ICOL_BLUE, v22, sy, v20, v19->_iAnimFrame, v19->_iAnimWidth, a5, 8);
					Cel2DecodeHdrLight(v22, sy, (char *)v19->_iAnimData, v19->_iAnimFrame, v19->_iAnimWidth, a5, 8);

					if (v52 - 1 != pcursitem && !VK_MENU)
						CelDrawHdrClrHL(ICOL_RED, v22, sy, v20, v19->_iAnimFrame, v19->_iAnimWidth, a5, 8);
					Cel2DecodeHdrLight(v22, sy, (char *)v19->_iAnimData, v19->_iAnimFrame, v19->_iAnimWidth, a5, 8);
				}
			}
		}
			...
			if ((unsigned char)v52 <= MAXITEMS) {
				...
				if (v40) {
					...
					if (v41 >= 1 && *(_DWORD *)v40 <= 0x32u && v41 <= *(_DWORD *)v40) {
						...
						if (v52 - 1 == pcursitem)
							CelDrawHdrClrHL(ICOL_WHITE, v42, sy, v40, v41, v39->_iAnimWidth, a5, 8);
						Cel2DecodeHdrLight(
							v42,
							sy,
							(char *)v39->_iAnimData,
						...
						Cel2DecodeHdrLight(
							...
							8);
						if (v52 - 1 != pcursitem && !VK_MENU)
							CelDrawHdrClrHL(ICOL_RED, v42, sy, v40, v41, v39->_iAnimWidth, a5, 8);
						Cel2DecodeHdrLight(
							v42,
							sy,
							(char *)v39->_iAnimData,
...
// 69CF94: using guessed type int cel_transparency_active;
// 69CF98: using guessed type int level_piece_id;
/*int __fastcall control_altkeys(int a1)
{
		...
		if (!v18->_iPostDraw && (unsigned char)v51 <= MAXITEMS) {
			...
			if (v19) {
				...
				if (v20 >= 1 && *(_DWORD *)v19 <= 0x32u && v20 <= *(_DWORD *)v19) {
					...
					if (v51 - 1 == pcursitem)
						CelDecodeClr(ICOL_WHITE, v21, sy, v19, v18->_iAnimFrame, v18->_iAnimWidth, 0, a5);
					CelDecodeHdrLightOnly(v21, sy, (char *)v18->_iAnimData, v18->_iAnimFrame, v18->_iAnimWidth, 0, a5);

					if (v51 - 1 != pcursitem && ALT == 0)
						CelDecodeClr(ICOL_BLUE, v21, sy, v19, v18->_iAnimFrame, v18->_iAnimWidth, 0, a5);
					CelDecodeHdrLightOnly(v21, sy, (char *)v18->_iAnimData, v18->_iAnimFrame, v18->_iAnimWidth, 0, a5);

					if (v51 - 1 != pcursitem && ALT == 1)
						CelDecodeClr(ICOL_RED, v21, sy, v19, v18->_iAnimFrame, v18->_iAnimWidth, 0, a5);
					CelDecodeHdrLightOnly(v21, sy, (char *)v18->_iAnimData, v18->_iAnimFrame, v18->_iAnimWidth, 0, a5);
				}
			}
		}
			...
			if ((unsigned char)v51 <= MAXITEMS) {
				...
				if (v39) {
					...
					if (v40 >= 1 && *(_DWORD *)v39 <= 0x32u && v40 <= *(_DWORD *)v39) {
						...
						if (v51 - 1 == pcursitem)
							CelDecodeClr(ICOL_WHITE, v41, sy, v39, v38->_iAnimFrame, v38->_iAnimWidth, 0, a5);
						...
						CelDecodeHdrLightOnly(
							...
							a5);
						if (v51 - 1 != pcursitem && ALT == 1)
							CelDecodeClr(ICOL_RED, v41, sy, v39, v38->_iAnimFrame, v38->_iAnimWidth, 0, a5);
						CelDecodeHdrLightOnly(
							v41,
							sy,
							(char *)v38->_iAnimData,
