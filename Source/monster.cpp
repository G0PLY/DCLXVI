...
void __fastcall InitMonster(int i, int rd, int mtype, int x, int y)
{
	...
	if (gnDifficulty == DIFF_NORMAL && gbMaxPlayers != 1) {
		...
		if (currlevel == 1) {
			...
			monster[i].mHit += 25;
			monster[i].mHit2 += 25;
			monster[i].mMinDamage = monster[i].mMinDamage;
			monster[i].mMaxDamage = monster[i].mMaxDamage;
			monster[i].mMinDamage2 = monster[i].mMinDamage2;
			monster[i].mMaxDamage2 = monster[i].mMaxDamage2;
			monster[i].mArmorClass += 2;
		}
		...
		if (currlevel == 6) {
			monster[i].mLevel += 5;
			monster[i]._mmaxhp = 1 * monster[i]._mmaxhp + 16;
			monster[i]._mhitpoints = monster[i]._mmaxhp;
			monster[i].mHit += 40;
			monster[i].mHit2 += 40;
			monster[i].mMinDamage = 1 * (monster[i].mMinDamage + 2);
		...
		if (currlevel == 9) {
			monster[i].mLevel += 8;
			monster[i]._mmaxhp = 3 * monster[i]._mmaxhp + 16;
			monster[i]._mhitpoints = monster[i]._mmaxhp;
			monster[i].mHit += 55;
			monster[i].mHit2 += 55;
			monster[i].mExp = 2 * (monster[i].mExp + 500);
			monster[i].mMinDamage = 1 * (monster[i].mMinDamage + 3);
			monster[i].mMaxDamage = 1 * (monster[i].mMaxDamage + 3);
			monster[i].mMinDamage2 = 1 * (monster[i].mMinDamage2 + 3);
			monster[i].mMaxDamage2 = 1 * (monster[i].mMaxDamage2 + 3);
		...
		if (currlevel == 11) {
			...
			monster[i].mHit2 += 65;
			monster[i].mExp = 2 * (monster[i].mExp + 500);
			monster[i].mMinDamage = 2 * (monster[i].mMinDamage);
			monster[i].mMaxDamage = 2 * (monster[i].mMaxDamage);
			monster[i].mMinDamage2 = 2 * (monster[i].mMinDamage2);
			monster[i].mMaxDamage2 = 2 * (monster[i].mMaxDamage2);
			monster[i].mArmorClass += 40;
			monster[i].mMagicRes = monst->MData->mMagicRes2;
		}
		...
		if (currlevel == 13) {
			monster[i].mLevel += 12;
			monster[i]._mmaxhp = 5 * monster[i]._mmaxhp + 32;
			monster[i]._mhitpoints = monster[i]._mmaxhp;
			monster[i].mHit += 75;
			monster[i].mHit2 += 75;
			monster[i].mExp = 2 * (monster[i].mExp + 1000);
			monster[i].mMinDamage = 2 * (monster[i].mMinDamage + 1);
			monster[i].mMaxDamage = 2 * (monster[i].mMaxDamage + 1);
			monster[i].mMinDamage2 = 2 * (monster[i].mMinDamage2 + 1);
		...
		if (currlevel == 15) {
			monster[i].mLevel += 14;
			monster[i]._mmaxhp = 6 * monster[i]._mmaxhp + 32;
			monster[i]._mhitpoints = monster[i]._mmaxhp;
			monster[i].mHit += 85;
			monster[i].mHit2 += 85;
			monster[i].mExp = 2 * (monster[i].mExp + 1000);
	...
	if (gnDifficulty == DIFF_NIGHTMARE) {
		...
		if (currlevel == 6) {
			monster[i].mLevel += 20;
			monster[i]._mmaxhp = 3 * monster[i]._mmaxhp + 128;
			monster[i]._mhitpoints = monster[i]._mmaxhp;
			monster[i].mHit += 100;
			monster[i].mHit2 += 100;
			monster[i].mExp = 2 * (monster[i].mExp + 1000);
		...
		if (currlevel == 9) {
			...
			monster[i].mMinDamage = 3 * (monster[i].mMinDamage + 5);
			monster[i].mMaxDamage = 3 * (monster[i].mMaxDamage + 5);
			monster[i].mMinDamage2 = 3 * (monster[i].mMinDamage2 + 5);
			monster[i].mMaxDamage2 = 3 * (monster[i].mMaxDamage2 + 5);
			monster[i].mArmorClass += 65;
		}
		...
		if (currlevel == 11) {
			monster[i].mLevel += 25;
			monster[i]._mmaxhp = 3 * monster[i]._mmaxhp + 192;
			monster[i]._mhitpoints = monster[i]._mmaxhp;
			monster[i].mHit += 115;
			monster[i].mHit2 += 115;
			monster[i].mExp = 3 * (monster[i].mExp + 1000);
		...
		if (currlevel == 13) {
			...
			monster[i].mHit2 += 120;
			monster[i].mExp = 3 * (monster[i].mExp + 1000);
			monster[i].mMinDamage = 4 * (monster[i].mMinDamage + 5);
			monster[i].mMaxDamage = 4 * (monster[i].mMaxDamage + 4);
			monster[i].mMinDamage2 = 4 * (monster[i].mMinDamage2 + 5);
			monster[i].mMaxDamage2 = 4 * (monster[i].mMaxDamage2 + 4);
			monster[i].mArmorClass += 75;
			monster[i].mMagicRes = monst->MData->mMagicRes2;
		}
		...
		if (currlevel == 14) {
			...
			monster[i].mExp = 3 * (monster[i].mExp + 1000);
			monster[i].mMinDamage = 4 * (monster[i].mMinDamage + 5);
			monster[i].mMaxDamage = 4 * (monster[i].mMaxDamage + 5);
			monster[i].mMinDamage2 = 4 * (monster[i].mMinDamage2 + 5);
			monster[i].mMaxDamage2 = 4 * (monster[i].mMaxDamage2 + 5);
			monster[i].mArmorClass += 80;
			monster[i].mMagicRes = monst->MData->mMagicRes2;
		}
